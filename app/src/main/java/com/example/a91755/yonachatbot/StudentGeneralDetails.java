...
public class StudentGeneralDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_general_details);
...
//                    arrayList.add(snapshot.getValue());
                ...
                ArrayAdapter<String> numAdapter = new ArrayAdapter<String>(StudentGeneralDetails.this,
        ...
        btnAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(StudentGeneralDetails.this,PostStudentGeneralDetails.class);
