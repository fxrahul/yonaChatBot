       ...
       arrayList.add("Select a Student Email");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    arrayList.add(snapshot.getValue(Student.class).getEmail() + "-" +snapshot.getValue(Student.class).getName());
//                    arrayList.add(snapshot.getValue(Student.class).getEmail());
//                    arrayList.add(snapshot.getValue());
                }

                ArrayAdapter<String> numAdapter = new ArrayAdapter<String>(AddAttendance.this,
        ...
        btnAttendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(AddAttendance.this,PostAddAttendance.class);
