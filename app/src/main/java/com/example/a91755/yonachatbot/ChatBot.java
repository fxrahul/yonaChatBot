    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeTheme.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ChatBot.this,ChatBotColor1.class));
                finish();
            }
        });
        btnLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                auth.signOut();
                finish();
                Toast.makeText(ChatBot.this,"Log Out Successfully",Toast.LENGTH_LONG).show();
                startActivity(new Intent(ChatBot.this,MainscreenActivity.class));
            }
        });
...
//              messages     = fulfillment.getJSONObject("messages");
//            imgUrl = messages.optString("imageURL");
...
//            }
    ...
    class RetrieveFeedTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(ChatBot.this,s,Toast.LENGTH_LONG);
            ...
            if(s.equals("I didn't get that. Can you say it again?")){
                if(userQuery == null){
                  ...
                  Toast.makeText(ChatBot.this,"Yona Cannot identify this query, this query will be added soon!",Toast.LENGTH_LONG).show();
